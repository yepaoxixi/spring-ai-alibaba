...
public class LlmService {
    ...
    public LlmService(ChatModel chatModel) {
        ...
        this.planningChatClient = ChatClient.builder(chatModel)
                ...
                .defaultOptions(DashScopeChatOptions.builder().withEnableThinking(false).build())
                .build();
        ...
        this.agentExecutionClient = ChatClient.builder(chatModel)
                ...
                .defaultAdvisors(new SimpleLoggerAdvisor())
                .defaultOptions(DashScopeChatOptions.builder().withInternalToolExecutionEnabled(false).withEnableThinking(false).build())
                .build();
